...
<body>
	  ...
	  <div class="card">
	    ...
	    <div class="card-body">
	    	<div class="row">
	    		<div class="col-lg-2"><!-- row클래스 안에서 비율나누기, 비율의 총합 12  -->
	    				...
	    				<div class="card-body">
	    					...
	    					<form action="">
	    						...
	    						<div class="form-group">
	    							...
	    							<input type="passwoard" class="form-control" id="memPwd" name="memPwd">
	    						</div>
	    				...
	    				<div class="card-body">
							<form id="regForm" action="${cpath}/register" method="post">
	    						...
	    						<div class="form-group">
	    							...
	    							<textarea class="form-control" id="content" name="content" placeholder="Enter Content" rows="7" cols=""></textarea>
	    						</div>
	    						<div class="form-group">
	    ...
	    <div class="card-footer">스피링 - 박한빈</div>
	  </div>
